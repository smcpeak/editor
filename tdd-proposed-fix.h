...
public:      // methods
  // create-tuple-class: declarations for TDD_TextEdit +move +gdvWrite +compare
...
public:      // methods
  // create-tuple-class: declarations for TDD_ProposedFix +move +gdvWrite +compare
